// TODO: Change the module name github.com/omaigo88 to your own and update all imports
module github.com/omaigo88/order
...
replace github.com/omaigo88/inventory => ../inventory

replace github.com/omaigo88/payment => ../payment
